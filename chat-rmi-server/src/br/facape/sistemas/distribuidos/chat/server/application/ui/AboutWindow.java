...
public class AboutWindow extends JDialog implements IWindow {
	...
	public AboutWindow() {
		...
		setModal(true);
		setResizable(false);
		setTitle("Chat RMI Server v1.0  [Sobre o sistema]");
		...
		this.label = new JLabel("Chat RMI Server");
		this.label.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
		this.label.setBounds(16, 8, 151, 24);
		...
		this.txtpnSistemaDesenvolvidoComo.setBorder(new TitledBorder(null, "Informa\u00E7\u00F5es do sistema", TitledBorder.LEADING, TitledBorder.TOP, null, null));
